package com.test.myapp.vcall.shyame;
...
import com.test.myapp.vcall.BuildConfig;
import com.test.myapp.vcall.R;
import com.test.myapp.vcall.VC_Terms_Activity;
import com.test.myapp.vcall.surmesham.hokebhi;
import com.test.myapp.vcall.tumsehi.haifasle;
...
public class newkese extends splashconnect_act {
    ...
    private void manageVip() {
        ...
        if (new hokebhi().getVipType().equals("in_app_gold")) {
            ...
            new Data_Preference(this).stopExtraAdsFlag();
