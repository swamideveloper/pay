package com.test.myapp.vcall.harghadi;
...
public class kyuhona extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        randomArray = new Uri[]{
                Uri.parse(aakhometeri.baseURL(kyuhona.this, defVal) + "video_14.mp4"),
                ...
                Uri.parse(aakhometeri.baseURL(kyuhona.this, defVal) + "video_20.mp4"),
                Uri.parse(aakhometeri.baseURL(kyuhona.this, defVal) + "video_21.mp4"),
                Uri.parse(aakhometeri.baseURL(kyuhona.this, defVal) + "video_22.mp4"),
                Uri.parse(aakhometeri.baseURL(kyuhona.this, defVal) + "video_23.mp4"),
                Uri.parse(aakhometeri.baseURL(kyuhona.this, defVal) + "video_24.mp4"),
                ...
                Uri.parse(aakhometeri.baseURL(kyuhona.this, defVal) + "video_105.mp4"),
                Uri.parse(aakhometeri.baseURL(kyuhona.this, defVal) + "video_106.mp4")
        };
