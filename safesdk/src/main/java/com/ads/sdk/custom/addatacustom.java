...
public class addatacustom {
    @SerializedName("PDALG1_wvb_cust_id")
    @Expose
    private String id;
    @SerializedName("PDALG1_wvb_cust_name")
    @Expose
    private String name;
    @SerializedName("PDALG1_wvb_cust_url")
    @Expose
    private String url;
    @SerializedName("PDALG1_wvb_cust_appopen_image")
    @Expose
    private String appopenImage;
    @SerializedName("PDALG1_wvb_cust_interstitial_image")
    @Expose
    private String interstitialImage;
    @SerializedName("PDALG1_wvb_cust_small_native_image")
    @Expose
    private String smallNativeImage;
    @SerializedName("PDALG1_wvb_cust_native_image")
    @Expose
