            ...
            call.enqueue(new Callback<JsonObject>() {
                ...
                public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                    ...
                    if (response.body() != null && response.body().get("status").getAsBoolean()) {
                        ...
                        jsonArray = app_seeting.getAsJsonArray("PDALG1_wvb_customAdData");
    ...
    public void getSplashMoreAppData(JsonArray response, Activity activity) {
        ...
        if (response != null) {
            for (int i = 0; i < response.size(); i++) {
                ...
                customAdData.add(new addatacustom(object.get("PDALG1_wvb_cust_id").getAsString(), object.get("PDALG1_wvb_cust_name").getAsString(), object.get("PDALG1_wvb_cust_url").getAsString(), object.get("PDALG1_wvb_cust_appopen_image").getAsString(), object.get("PDALG1_wvb_cust_interstitial_image").getAsString(), object.get("PDALG1_wvb_cust_small_native_image").getAsString(), object.get("PDALG1_wvb_cust_native_image").getAsString()));
            }
            //notification
