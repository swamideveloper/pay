...
public class Data_Config {
    ...
    public static String baseURL(Context applicationContext, String packageName) {
        try {
            return decrypt("8AA00DDFD493118501DBC929CED2474335E9AF0EBE598BE31195300A968E61ED2E1AAA980F355F7E8C636DEE96B0E35452544087DF04F9000C0BE38D659C8618", applicationContext.getResources().getString(R.string.pass));
    ...
    public static String apiHost(Context applicationContext, String packageName) {
        try {
            return decrypt("3CD47B3A8AAA15EB954EB52F6203F44D", applicationContext.getResources().getString(R.string.pass));
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
        } catch (NoSuchPaddingException e) {
            e.printStackTrace();
